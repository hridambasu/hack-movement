...
impl Block {
    ...
    /*fn calculate_hash(&self) -> String {
        // Assuming you have a hash calculation method, replace this with your actual implementation
        // For example, using a cryptographic hash function like SHA-256
        format!("{:x}", sha256::digest(format!("{:?}", self).as_bytes()))
    }*/
